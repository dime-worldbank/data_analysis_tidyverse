...
- Like in a project you will start the script, with a clear title of the purpose (this is the example folder in the repo) analysis_tidyverse.R for you to continue and follow along with the examples if you want, if you don't you can just follow the presentation. 
...
- This approach can lead to complex and unreadable code.
...
The Tidyverse packages works better and should be performed using tidy data. 

To achieve this one of the most common and useful operations you will do are the reshape of your data. 
